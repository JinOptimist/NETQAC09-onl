class Maltsev
{
    public void Do()
    {
        ...
        Console.WriteLine($"Hello! Do you want to play by yorself or let the computer to generate number? Enter 1 for self and 2 for computer. And remember, the number must be beetween {MIN_NUMBER} and {MAX_NUMBER}");
        ...
        do
        {
            ...
            isNumber = int.TryParse(guessText, out userMagicNumber);
