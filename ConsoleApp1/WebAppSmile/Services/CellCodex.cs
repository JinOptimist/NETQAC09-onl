...
public static class CellCodex
{
    ...
    [
        ...
        new() { TypeKey = "Dirt", TitleRu = "Грязь", Category = "Местность", Teaser = "Трясина под ногами — следы остаются дольше обычного.", Link = "Dirt" },
        new() { TypeKey = "Ice", TitleRu = "Лёд", Category = "Местность", Teaser = "Скользкая плита: шаг может унести вас дальше.", Link = "Ice" },
        ...
        new() { TypeKey = "PileOfSand", TitleRu = "Куча песка", Category = "Добыча", Teaser = "Горсть песка. Можно унести с собой.", Link = "PileOfSand" },
        ...
        new() { TypeKey = "Snake", TitleRu = "Змея", Category = "Опасность", Teaser = "Ползучий гость. Жалит и ползёт дальше по коридорам.", Link = "Snake" },
