...
public static class CellCodex
{
    ...
    [
        ...
        new() { TypeKey = "Dirt", TitleRu = "Грязь", Category = "Местность", Teaser = "Трясина под ногами — следы остаются дольше обычного.", DetailAction = "Dirt" },
        new() { TypeKey = "Ice", TitleRu = "Лёд", Category = "Местность", Teaser = "Скользкая плита: шаг может унести вас дальше.", DetailAction = "Ice" },
        ...
        new() { TypeKey = "PileOfSand", TitleRu = "Куча песка", Category = "Добыча", Teaser = "Горсть песка. Можно унести с собой.", DetailAction = "PileOfSand" },
